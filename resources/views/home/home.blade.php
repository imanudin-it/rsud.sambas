          ...
          <div class="owl-item">
            <div class="card">
              <div class="card-body mb-0 p-0" style="max-height: 300px; overflow: hidden;">
               <img alt="image" src="{{ asset('/storage/slide-header/'.$image) }}" width="100%" height="300" style="border-radius:10px;" class=" bt-primary">
            </div>
            </div>
          </div>
        @endforeach
...
<div class="p-lg-4 p-2 container-xxxl container-lg-fluid flex-grow-1"> 
  <div class="row">
                  ...
                  <div class="card h-100 mb-3">
                    <div class="row g-0">
                      <div class="col-md-4">
                        ...
                        <img class="card-img card-img-left " src="{{ asset('storage/dokter/'.$dokter->foto) }}" alt="Card image" style="max-height: 200px;
    overflow: hidden;">
                        @else
      ...
      <div class="row">
        <div class="d-grid gap-2 col-lg-6 mx-auto">
          <a class="btn bg-label-primary btn-lg link hover" href="/jadwal-dokter"><i class='bx bx-user-circle bx-tada'></i> Lihat Jadwal Dokter</a>
        </div>
      </div>
  </div>
...
{{-- Postingan --}}
<div class="p-lg-4 p-2 container-xxxl flex-grow-1"> 
  <div class="divider text-center">
    <div class="divider-text">
