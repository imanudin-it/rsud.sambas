<div class="divider text-center pt-3">
    <div class="divider-text">
      <h5 class="text-muted fw-bold"> <i class='bx bx-menu-alt-left bx-tada' ></i> Menu : </h5>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-6 col-md-6 col-lg-6">
      <div class="shadow card mb-3 link">
        <div class="card-body">
          <a href="#"data-bs-toggle="offcanvas" data-bs-target="#infoPelayanan" aria-controls="offcanvasStart">
             <div class="card-title d-flex align-items-start justify-content-between">
