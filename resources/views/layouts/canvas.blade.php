...
@endphp
 ...
 {{-- Canvas Daftar Online --}}
    ...
    >
      <div class="offcanvas-header">
        <h5 id="offcanvasStartLabel" class="offcanvas-title"><i class='bx bxs-user-account bx-flip-horizontal bx-tada' ></i> PENDAFTARAN ONLINE </h5>
        <button
          type="button"
          class="btn-close text-reset"
          data-bs-dismiss="offcanvas"
      ...
      <div class="offcanvas-body my-auto mx-0 flex-grow-0">
        ...
        <a href="https://play.google.com/store/apps/details?id=com.rsudsambas.co.id">
             <div class="card mb-3">
                <div class="card-body text-center"><a href="https://play.google.com/store/apps/details?id=com.rsudsambas.co.id"><img src="{{ asset('assets/img/daftar-online/via-rsud.jpg') }}" width="250"></a></div> 
              </div>
        </a>
        <a href="https://play.google.com/store/apps/details?id=app.bpjs.mobile">
              <div class="card mb-3">
                <div class="card-body text-center"><a href="https://play.google.com/store/apps/details?id=app.bpjs.mobile"><img src="{{ asset('assets/img/daftar-online/via-jkn.jpg') }}" width="250"></a>
                </div> 
            </div>
        </a>
      </div>
